def solution(places, answer=[]):
    def safe(r, c, matrix):
        ...
        if mat[1][2]==1 or mat[2][1]==1 or mat[2][3]==1 or mat[3][2]==1 or \
        (mat[0][2]+mat[1][2])>0 or (mat[2][0]+mat[2][1])>0 or (mat[2][4]+mat[2][3])>0 or (mat[4][2]+mat[3][2])>0 or \
        (mat[1][1]==1 and mat[1][1]+mat[1][2]+mat[2][1]>-1) or (mat[1][3]==1 and  mat[1][3]+mat[1][2]+mat[2][3]>-1) or \
